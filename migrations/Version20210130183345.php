 ...
 */
final class Version20210130183345 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE file (id INT NOT NULL, owner_id INT NOT NULL, name VARCHAR(255) NOT NULL, mime_type VARCHAR(255) NOT NULL, size BIGINT NOT NULL, path VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
